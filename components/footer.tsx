                    ...
                    <Row>
                        <Col sm={12} lg={12}>
                            <ul className="list-unstyled">
                                <li className='mb-1'><a target="_blank" rel="noreferrer" href="https://www.gnu.org/licenses/agpl-3.0.html"><Image style={{background:"white"}} src="/images/agplv3-88x31.png" /></a> <a target="_blank" rel="noreferrer" style={{ color: "#FFFFFF" }}href="https://github.com/LibreSchemas/libreschemas-client-react-native-expo">LibreSchemas Client using React Native Expo</a></li>
                                <li className='mb-1'><a target="_blank" rel="noreferrer" href="https://www.gnu.org/licenses/agpl-3.0.html"><Image style={{background:"white"}} src="/images/agplv3-88x31.png" /></a> <a target="_blank" rel="noreferrer" style={{ color: "#FFFFFF" }}href="https://github.com/LibreSchemas/libreschemas-client-react-native">LibreSchemas Client using React Native</a></li>
                                <li className='mb-1'><a target="_blank" rel="noreferrer" href="https://www.gnu.org/licenses/agpl-3.0.html"><Image style={{background:"white"}} src="/images/agplv3-88x31.png" /></a> <a target="_blank" rel="noreferrer" style={{ color: "#FFFFFF" }}href="https://github.com/LibreSchemas/libreschemas-server-api-react">LibreSchemas Server API using React Next.js</a></li>
                                <li className='mb-1'><a target="_blank" rel="noreferrer" href="https://www.gnu.org/licenses/agpl-3.0.html"><Image style={{background:"white"}} src="/images/agplv3-88x31.png" /></a> <a target="_blank" rel="noreferrer" style={{ color: "#FFFFFF" }}href="https://github.com/LibreSchemas/libreschemas-website-react">LibreSchemas Website using React Next.js</a></li>
