        ...
        <div className="pt-3" style={{color:"white", bottom: 0, width: "100%"}}>
            <Row className="p-3">
                ...
                <Col sm={12} lg={4}>
                    ...
                    <Row>
                        <Col sm={12} lg={12}>
                            <p style={{fontSize: 14}}>The LibreSchemas Website using React Next.js is free software: you can redistribute it and/or modify it under the terms of the <a style={{ color: "#FFFFFF"}} target="_blank" href="https://www.gnu.org/licenses/agpl-3.0.en.html">GNU Affero General Public License</a> as published by the <a style={{ color: "#FFFFFF"}} target="_blank" href="https://www.fsf.org">Free Software Foundation</a>, either version 3 of the License, or (at your option) any later version. LibreSchemas Website using React Next.js is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the <a style={{ color: "#FFFFFF"}} target="_blank" href="https://www.gnu.org/licenses/agpl-3.0.en.html">GNU Affero General Public License</a> for more details. You should have received <a style={{ color: "#FFFFFF"}} target="_blank" href="https://github.com/LibreSchemas/libreschemas-website-react/blob/main/LICENSE.md">a copy of the GNU Affero General Public License</a> along with <a style={{ color: "#FFFFFF"}} target="_blank" href="https://github.com/LibreSchemas/libreschemas-website-react">LibreSchemas Website using React Next.js</a>. If not, see <a style={{ color: "#FFFFFF"}} target="_blank" href="https://www.gnu.org/licenses">https://www.gnu.org/licenses</a>.</p>
                        </Col>
                    </Row>
                </Col>
            </Row>
