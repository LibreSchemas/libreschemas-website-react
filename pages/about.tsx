...
function About() {
  return (<div>
    <Container className="my-3">
      ...
      <Row>
        <Col md={12}>
          <p>The LibreSchemas project is a collection of Free and Open Source Software (FOSS), under various Copyleft licenses, that are designed to help those who identify as Neurodivergent (read more about the Neurodiversity Movement <a target="_blank" href="https://neurodiversity2.blogspot.com/p/what.html">here</a>). Libre means being “free, having liberty, at liberty” in Spanish and French. The Schemas part of LibreSchemas was originally derived from <a target="_blank" href="https://neuroschemas.app">NeuroSchemas</a>, an original App created by Shaun Vos, that was released in June 2021 to assist Autistic people in learning the hidden curriculum from its Social Schemas. The mission of the LibreSchemas project is to create and make FOSS that the Neurodiverse community finds helpful as well as making it accessible for the community to new learn skills and contribute for the benefit of all Neurodiverse people.</p>
        ...
        <Col md={12}>
          ...
          <ul>
                                <li className='mb-1'><a target="_blank" rel="license" href="https://www.gnu.org/licenses/agpl-3.0.html"><Image style={{background:"white"}} src="/images/agplv3-88x31.png" /></a> <a target="_blank" href="https://github.com/LibreSchemas/libreschemas-client-react-native-expo">LibreSchemas Client using React Native Expo</a></li>
                                <li className='mb-1'><a target="_blank" rel="license" href="https://www.gnu.org/licenses/agpl-3.0.html"><Image style={{background:"white"}} src="/images/agplv3-88x31.png" /></a> <a target="_blank" href="https://github.com/LibreSchemas/libreschemas-client-react-native">LibreSchemas Client using React Native </a></li>
                                <li className='mb-1'><a target="_blank" rel="license" href="https://www.gnu.org/licenses/agpl-3.0.html"><Image style={{background:"white"}} src="/images/agplv3-88x31.png" /></a> <a target="_blank" href="https://github.com/LibreSchemas/libreschemas-server-api-react">LibreSchemas Server API using React Next.js</a></li>
                                <li className='mb-1'><a target="_blank" rel="license" href="https://www.gnu.org/licenses/agpl-3.0.html"><Image style={{background:"white"}} src="/images/agplv3-88x31.png" /></a> <a target="_blank" href="https://github.com/LibreSchemas/libreschemas-website-react">LibreSchemas Website using React Next.js</a></li>
                                </ul>
