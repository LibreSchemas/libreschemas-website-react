...
function About() {
  return (<div>
    <Container className="my-3">
      ...
      <Row>
        <Col md={12}>
          <p>The LibreSchemas project is a collection of Free and Open Source Software (FOSS), under various Copyleft licenses, that are designed to help those who identify as Neurodivergent (read more about the Neurodiversity Movement <a target="_blank" href="https://neurodiversity2.blogspot.com/p/what.html">here</a>). LibreSchemas was originally derived from <a target="_blank" href="https://neuroschemas.app">NeuroSchemas</a>, an original App created by Shaun Vos, that was released in June 2021 to assist Autistic people in learning the hidden curriculum from Social Schemas.</p>
