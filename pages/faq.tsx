  ...
  return (<div>
    <Container className="my-3">
      ...
      <Row>
        ...
        <p>We want to limit a <a target="_blank" rel="noreferrer" href="https://en.wikipedia.org/wiki/Free-rider_problem">Free-rider problem</a> whereby individuals or organisations could potentially use our software to benefit financially and not return the favour by publishing any modifications or upgrades they made as Free and Open Source Software (FOSS). If you want to use LibreSchemas code in your projects then you are legally required to publish modifications under the same Copyleft license (FOSS).</p>
        <b>What is the difference between NeuroSchemas and LibreSchemas?</b>
        <p><a target="_blank" rel="noreferrer" href="https://neuroschemas.app">NeuroSchemas</a> is a Google Play and Apple App Store App developed by <a target="_blank" rel="noreferrer" href="https://github.com/devmindset-shaunvos">Shaun Vos</a> on behalf of <a target="_blank" rel="noreferrer" href="https://www.devmindset.co.uk">Dev Mindset Community Interest Company</a> which owns the copyright. NeuroSchemas used React Native but was converted over to the beginner friendly Expo edition of React Native so code could be ported over to LibreSchemas more easily. NeuroSchemas contains copyrighted works that Dev Mindset owns and has license to use from other providers such as stock photo images.<br/> LibraSchemas is Free and Open Source Software (FOSS) released under Copyleft licenses and contains only copyrighted works permitted to be used under Copyleft. Though much code has been ported over from NeuroSchemas as well as much being written from scratch. LibreSchemas isn&apos;t presently in any App stores as NeuroSchemas more than serves this purpose. If LibreSchemas was to diverge from NeuroSchemas (due to new volunteer contributions) then an App store release could be warranted. For now LibreSchemas relationship with NeuroSchemas is similar to the <a target="_blank" rel="noreferrer" href="https://www.chromium.org/chromium-projects">Chromium Projects</a> relationship to the <a target="_blank" rel="noreferrer" href="https://www.google.com/chrome">Chrome Browser</a>.</p>
