  ...
  return (<div>
    <Container className="my-3">
      ...
      <Row>
        ...
        <p>You can use <a target="_blank" href="/files/libreschemas_generic_schema_template.xlsx">this Excel template for now</a> and either email us or push it into the relevant GitHub Datasets Repositories. If you are confident with the JSON file format then you can just create your own and push it into the datasets repositories. We would like to eventually create a form online that allows you to submit Schemas (any volunteers?).</p>
        </Col>
    </Row>
    </Container>
    </div>
