    ...
    <Container className="my-3">
      ...
      <Row>
        <Col md={12}>
          ...
          <p>The mission of the LibreSchemas project is to create and make FOSS that the Neurodiverse community finds helpful as well as making it accessible for the community to new learn skills and contribute for the benefit of all Neurodiverse people. By LibreSchemas being Open Source, the source code is made freely available for modification and redistribution. This allows anyone to co-produce LibreSchemas (including anonymously) or start their own fork (a copy of some or all of LibreSchemas) even if it is discontinued.</p>
