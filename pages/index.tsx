    ...
    <Container className="my-3">
      ...
      <Row>
        <Col md={12}>
          ...
          <p>The mission of the LibreSchemas project is to create and make FOSS that the Neurodiverse community finds helpful as well as making it accessible for the community to learn new skills and contribute for the benefit of all Neurodiverse people. By LibreSchemas being Open Source, the source code is made freely available for modification and redistribution. This allows anyone to co-produce LibreSchemas (including anonymously) or start their own fork (a copy of some or all of LibreSchemas) even if it is discontinued.</p>
          <h5 className="text-start">Copyleft vs Copyright Licensing</h5>
          <p>Many are familiar with the term Copyright whereby the creator or owner of a creative work has the exclusive right to distribute and adapt a work plus the economic rights on how it is used. Creators can mark their work with the <span style={{ fontWeight: "bold" }}>©</span> symbol to indicate copyright since the Berne Convention of 1886. Examples of proprietary copyrighted work are <a target="_blank" rel="noreferrer" href="https://www.office.com">Microsoft Office</a>, <a target="_blank" rel="noreferrer" href="https://twitter.com">Twitter</a>, the <a target="_blank" rel="noreferrer" href="https://www.britannica.com">Encyclopædia Britannica</a> and <a target="_blank" rel="noreferrer" href="https://neuroschemas.app">NeuroSchemas</a>.</p>
        ...
        <Col md={12}>
          ...
          <ul>
                                <li className='mb-1'><a target="_blank" rel="noreferrer" href="https://www.gnu.org/licenses/agpl-3.0.html"><Image style={{background:"white"}} src="/images/agplv3-88x31.png" /></a> <a target="_blank" rel="noreferrer" href="https://github.com/LibreSchemas/libreschemas-client">LibreSchemas Client</a></li>
                                <li className='mb-1'><a target="_blank" rel="noreferrer" href="https://www.gnu.org/licenses/agpl-3.0.html"><Image style={{background:"white"}} src="/images/agplv3-88x31.png" /></a> <a target="_blank" rel="noreferrer" href="https://github.com/LibreSchemas/libreschemas-server-api-react">LibreSchemas Server</a></li>
                                <li className='mb-1'><a target="_blank" rel="noreferrer" href="https://www.gnu.org/licenses/agpl-3.0.html"><Image style={{background:"white"}} src="/images/agplv3-88x31.png" /></a> <a target="_blank" rel="noreferrer" href="https://github.com/LibreSchemas/libreschemas-website-react">LibreSchemas Website</a></li>
                                </ul>
          <p>Additionally, the datasets have three distinct GitHub repositories under the licenses of the Creative Commons BY-SA 4.0, GNU General Public License Version 3 and GNU Affero General Public License Version 3. The datasets have been licensed this way to meet different contributors needs. The datasets are in JSON format only and designed to be imported into a database such as MongoDB.</p>
                              <ul>
